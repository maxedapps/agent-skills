...
- Use current docs/source research when judging third-party APIs, framework behavior, security assumptions, or migration requirements; read the `code-research` or `web-research` skill when applicable.
